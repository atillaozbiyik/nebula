...
"}")
        ...
        self.fileButton = QtWidgets.QPushButton(self.buttonBox)
        self.fileButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fileButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/resources/file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fileButton.setIcon(icon)
        self.fileButton.setObjectName("fileButton")
        self.horizontalLayout.addWidget(self.fileButton)
        self.folderButton = QtWidgets.QPushButton(self.buttonBox)
        self.folderButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.folderButton.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/resources/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.folderButton.setIcon(icon1)
        self.folderButton.setObjectName("folderButton")
        self.horizontalLayout.addWidget(self.folderButton)
        self.saveButton = QtWidgets.QPushButton(self.buttonBox)
        self.saveButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.saveButton.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/resources/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/resources/run.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.cleanButton.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.cleanButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.cleanButton.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/resources/clean.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.installButton.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.installButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.installButton.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/resources/install.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.installButton.setIcon(icon5)
        ...
        self.debugButton.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.debugButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.debugButton.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/resources/debug.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.debugButton.setIcon(icon6)
